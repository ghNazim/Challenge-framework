const firstStageQuestions = [
  ...
  {
    question:
      "A library has 12,580 fiction books and 15,320 non-fiction books. What is Total number of books in the library?",
    numbers: [12580, 15320],
    ...
    toFind: ["What is Total number of books in the library?"],
    toFindFacts: ["Find Total number of books."],
  },
  {
    question:
    ...
    toFindFacts: ["Find Total number of cars manufactured."],
  },
];
...
const textPoolEnglish = {
  ...
  first_stage_4:
    "We need to add to find Total amount of stored rice.",

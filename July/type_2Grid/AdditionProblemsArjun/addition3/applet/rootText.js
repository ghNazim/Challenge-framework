...
const textPoolEnglish = {
  answer_of_question: `<span>Answer: Total budget is {{answer}} kg</span>`,
  ...
  first_stage_4: "We need to add to find the total budget.",
  ...
  final_summary:
    "You have solved the problem. The total budget is {{answer}}.",
  combine:

...
const textPoolEnglish = {
  answer_of_question: `<span>Answer: Total amount of money collected: Rp{{answer}} kg</span>`,
  ...
  first_stage_4: "We need to add to find Total amount of money collected.",
  ...
  hundreds_carryover:
    "Uh oh! We have more than 9 in the hundreds place. Tap on the number to do a carry over.",
  hundreds_carryover2:
  ...
  final_summary:
    "You have solved the problem. Your final answer is {{answer}}.",
  combine:
...
const mcqDataIndonesian = {
  ...
  add_tens: {
    ...
    wrong_feedback: "Ups, itu salah. Mari coba lagi.",
  },
  add_hundreds: {
    question: "{{h1x}} + {{h2x}} {{tOverflowStr}} =",
    options: ["{{hsumx_minus}}", "{{hsumx_plus}}", "{{hsumx}}"],
  ...
  ones_split: {
    question:
      "Kita tidak bisa memiliki {{osumx}} di nilai tempat satuan.<br> Angka manakah yang harus kita simpan?",
    options: ["1", "{{o3}}", "{{osum}}"],
    answer_index: 0,
  ...
  tens_split: {
    question:
      "Kita tidak bisa memiliki {{tsumx}} di nilai tempat puluhan.<br> Angka manakah yang harus kita simpan?",
    options: ["1", "{{t3}}", "{{tsum}}"],
    answer_index: 0,
    correct_feedback: "Kerja bagus!",
    wrong_feedback: "Bukan itu yang harus disimpan. Coba lagi.",
  ...
  hundreds_split: {
    question:
      "Kita tidak bisa memiliki {{hsumx}} di nilai tempat ratusan.<br> Angka manakah yang harus kita simpan?",
    options: ["1", "0", "{{hsum}}"],
    answer_index: 0,
    correct_feedback: "Bagus sekali!",
    wrong_feedback: "Bukan itu yang harus disimpan. Coba lagi.",
  ...
  thousands_split: {
    question:
      "Kita tidak bisa memiliki {{thsumx}} di nilai tempat ribuan.<br> Angka manakah yang harus kita simpan?",
    options: ["1", "0", "{{thsum}}"],
    answer_index: 0,
    correct_feedback: "Sempurna!",
    wrong_feedback: "Bukan itu yang harus disimpan. Coba lagi.",

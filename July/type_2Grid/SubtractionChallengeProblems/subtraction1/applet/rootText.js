const firstStageQuestions = [
  {
    ...
    givenFacts: [
      "Given:",
      "Initial rice in storage: 91,000 kg",
      "Rice remaining: 57,500 kg",
    ],
    toFind: ["How much rice was distributed"],
    toFindFacts: ["To find:", "The amount of rice distributed"],
  },
  {
    question:
...
const textPoolEnglish = {
  ...
  first_stage_4: "We need to subtract to find the amount of rice distributed.",

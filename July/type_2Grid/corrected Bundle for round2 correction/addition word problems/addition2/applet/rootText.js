...
const textPoolIndonesian = {
  ...
  ones_carryover2:
    "Bagus! kita telah memisahkan {{osumx}} dengan benar. Ketuk untuk Menyimpan.'.",
  ones_complete:
  ...
  tens_carryover2:
    "Bagus! Kita telah memisahkan {{tsumx}} dengan benar. Ketuk untuk Menyimpan.",
  tens_complete:
  ...
  hundreds_carryover2:
    "Anda telah memisahkan {{hsumx}} dengan benar. Ketuk untuk Menyimpan.",
  hundreds_complete:
  ...
  thousands_carryover2: "Pemisahan Sempurna. Ketuk untuk Menyimpan.",
  thousands_complete:

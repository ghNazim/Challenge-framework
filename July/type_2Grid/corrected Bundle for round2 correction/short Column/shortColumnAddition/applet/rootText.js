const mcqDataEnglish = {
  ...
  ones_split: {
    question:
      "We can't have {{osumx}} in ones place.<br> Which digit should we carry forward?",
    options: ["1", "{{o3}}", "{{osum}}"],
    answer_index: 0,
...
const textPoolEnglish = {
  ...
  after_split: "We have 5 places to add. Recall we go from right to left.",
  ...
  combine:
    "Now we need to compose the answer from results of all column additions.<br> Tap on the highlighted part.",
  mcq_one:

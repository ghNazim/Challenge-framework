...
const textPoolIndonesian = {
  ...
  final_summary:
    "Kamu telah menyelesaikan penjumlahan. Jumlah uang yang dibelanjakan adalah Rp64.500.",
  move_to_subtraction:
    "Rudi membelanjakan Rp64.500. Sekarang, mari kita lakukan pengurangan untuk mencari tahu sisa uang Rudi.",
  combine:

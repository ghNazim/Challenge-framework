...
const textsIndonesian = {
  ...
  instructions: {
    ...
    set1_correct:
      "Kerja bagus! Kamu telah mengatur angka pertama dengan benar. Sekarang mari atur angka kedua.",
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        ...
        "Pecahkan menjadi kubus yang lebih kecil",
    ...
    {
      question: "Berapa jumlah dari {{h1}}, {{h2}} dan {{overflowTens}}?",
      options: ["{{hSumMinus}}", "{{hSumPlus}}", "{{hSum}}"],
      correctAnswer: 2,
    },
  ],

...
const textsIndonesian = {
  ...
  instructions: {
    ...
    set1_correct:
      "Kerja bagus! Kamu sudah mengatur angka pertama dengan benar. Sekarang mari atur angka kedua.",

    set2: "Gunakan tombol '+' dan '-' untuk mengatur angka kedua.",
    set1_success:
      "Kamu telah mengatur angka pertama dengan benar. Sekarang mari atur angka kedua.",
    set2_success:
...
const mcqObjectIndonesian = {
  questions: [
    ...
    {
      question:
        "Tempat satuan tidak bisa menampung lebih dari 9 kubus. Apa yang harus kita lakukan selanjutnya?",
      options: [
        "Abaikan kubus ekstra",
        "Pecahkan menjadi kubus lebih kecil",
        "Pindahkan 10 kubus ke tempat puluhan.",
      ],
      correctAnswer: 2,
    },
    {

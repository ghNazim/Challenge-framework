const textsEnglish = {
  ...
  comments: {
    ...
    tenThousand_overflow:
      "The yellow jar is wiggling, it can’t hold more than 9 gold-bars.",
    ...
    hundredThousand:
      "10 Ones = 1 Ten | 10 Tens = 1 Hundred | 10 Hundreds = 1 Thousand <br> 10 Thousands = 1 Ten Thousand | <b>10 Ten Thousands = 1 Hundred Thousand</b>",
  },
  left_panel: {
...
const tagsArrayEnglish = ["Ones", "Tens", "Hundreds", "Thousands", "Ten Thousands", "Hundred Thousands"];
const tagsEnglish = {
  one: " One",
  ten: " Ten",
  hundred: " Hundred",
...
const textsIndonesian = {
  ...
  comments: {
    ...
    tenThousand_overflow:
      "Toples kuning bergoyang, tidak bisa menampung lebih dari 9 batangan emas!",
    ...
    hundredThousand:
      "10 Satuan = 1 Puluhan | 10 Puluhan = 1 Ratusan | 10 Ratusan = 1 Ribuan <br> 10 Ribuan = 1 Puluh Ribu | <b>10 Puluh Ribu = 1 Ratus Ribu</b>",
  },
  left_panel: {
    general:

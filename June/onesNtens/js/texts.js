...
const texts = {
  ...
  comments: {
    number_disappeared:
      "Opps! the number disappeared! Looks like this number display box can’t show the count of that many squares.The Way to resolve this is by adding another Jar!",
